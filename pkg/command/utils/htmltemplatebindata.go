...
var _bindata = map[string]func() (*asset, error){
	"Users/zyjiaobj/Code/knative-sandbox/kperf/templates/single_chart.html": usersZyjiaobjCodeKnativeSandboxKperfTemplatesSingle_chartHtml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Users": &bintree{nil, map[string]*bintree{
		"zyjiaobj": &bintree{nil, map[string]*bintree{
				...
				"knative-sandbox": &bintree{nil, map[string]*bintree{
					"kperf": &bintree{nil, map[string]*bintree{
						"templates": &bintree{nil, map[string]*bintree{
							"single_chart.html": &bintree{usersZyjiaobjCodeKnativeSandboxKperfTemplatesSingle_chartHtml, map[string]*bintree{}},
						}},
					}},
				}},
			}},
