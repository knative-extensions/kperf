...
var _bindata = map[string]func() (*asset, error){
	"home/qiye/workspace/src/github.com/knative-sandbox/kperf/templates/single_chart.html": homeQiyeWorkspaceSrcGithubComKnativeSandboxKperfTemplatesSingle_chartHtml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"home": &bintree{nil, map[string]*bintree{
		"qiye": &bintree{nil, map[string]*bintree{
			"workspace": &bintree{nil, map[string]*bintree{
				"src": &bintree{nil, map[string]*bintree{
					"github.com": &bintree{nil, map[string]*bintree{
						"knative-sandbox": &bintree{nil, map[string]*bintree{
							"kperf": &bintree{nil, map[string]*bintree{
								"templates": &bintree{nil, map[string]*bintree{
									"single_chart.html": &bintree{homeQiyeWorkspaceSrcGithubComKnativeSandboxKperfTemplatesSingle_chartHtml, map[string]*bintree{}},
								}},
							}},
						}},
					}},
