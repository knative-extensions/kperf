...
// sources:
// templates/single_chart.html (15.539kB)
...
var _bindata = map[string]func() (*asset, error){
	"Users/huangxin/Documents/Knative/kperf/templates/single_chart.html": usersHuangxinDocumentsKnativeKperfTemplatesSingle_chartHtml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Users": {nil, map[string]*bintree{
		"huangxin": {nil, map[string]*bintree{
			"Documents": {nil, map[string]*bintree{
				"Knative": {nil, map[string]*bintree{
					"kperf": {nil, map[string]*bintree{
						"templates": {nil, map[string]*bintree{
							"single_chart.html": {usersHuangxinDocumentsKnativeKperfTemplatesSingle_chartHtml, map[string]*bintree{}},
						}},
					}},
				}},
			}},
